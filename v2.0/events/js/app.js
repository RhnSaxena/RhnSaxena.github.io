...
app.search.init = () => {
  ...
  document.addEventListener("app:menuDidHide", app.search.showIcon);
  document.addEventListener("app:menuWillShow", app.search.hideIcon);
  // Click handlers
...
app.menu.reveal = (e) => {
  ...
  app.menu.toggleStates();
  document.dispatchEvent(new Event("app:menuWillShow"));
