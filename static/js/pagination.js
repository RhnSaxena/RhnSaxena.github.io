// This global variable is for the total number
// of instances present in the query result
var total_count;

// This global variable is the number of
// entries to be shown in the list
...
function createButtons(N) {
  ...
  if (N != no_of_pages) {
    stats +=
      (N - 1) * pagination_page_size +
      1 +
      " - " +
      N * pagination_page_size +
      " out of " +
      total_count;
  } else {
    stats +=
